...
enum S {
    ...
    enum Settings {
        ...
        static let contactSupport = NSLocalizedString("Settings.contactSupport", value: "**Contact support**", comment: "Header to contact Litewallet support")
        static let blockchain = NSLocalizedString("Settings.blockchain", value: "**Blockchain**", comment: "Blockchain settings section header")
        static let importTitle = NSLocalizedString("Settings.importTitle", value: "**Import Wallet**", comment: "Import wallet label")
